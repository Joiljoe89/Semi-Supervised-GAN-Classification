...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan  2 18:26:46 2020
...
json_file = open('/home/joe/Desktop/sgan/sgan_test/model_512_32_50ki_5class_200img/mnist_sgan_discriminator.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.summary()
# load weights into new model
loaded_model.load_weights("/home/joe/Desktop/sgan/sgan_test/model_512_32_50ki_5class_200img/mnist_sgan_discriminator_weights.hdf5")
print("Loaded model from disk")

loaded_model.compile(loss='binary_crossentropy', optimizer='rmsprop', metrics=['accuracy'])
img_test = cv2.imread('/home/joe/Desktop/sgan/train/patch/train_data/pumkin/ocn2.jpg')
img_test = img_test.reshape(1,200,200,3)
valid, label = loaded_model.predict(img_test)
